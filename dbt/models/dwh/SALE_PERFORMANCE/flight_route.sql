...
with a as
(
select date(createddate) bookingdate,
       ordercode,
...
case when lower(startpoint) like '%nội bài%' or lower(startpoint) like '%noi bai%' then 'HN'
                     ...
                     when lower(startpoint) like '%trà nóc%' or lower(startpoint) like '%tra noc%' then 'CT'
...
case when lower(endpoint) like '%nội bài%' or lower(endpoint) like '%noi bai%' then 'HN'
                     ...
                     when lower(endpoint) like '%trà nóc%' or lower(endpoint) like '%tra noc%' then 'CT'
